...
public class Ratings extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isNetworkAvailable()){
        	Toast.makeText(getBaseContext(), "Please connect to the Internet so you can like/share/comment!", Toast.LENGTH_LONG).show();
        }
	}
	...
	private void initSocialize() {
        ...
        android.view.View actionBarWrapped = ActionBarUtils.showActionBar(this,
                R.layout.activity_ratings, entity,options,listener);
		...
		//dimiourgeia kai arxokopoihsh tou TabHost
				...
				th.setOnTabChangedListener(new OnTabChangeListener(){
					...
					public void onTabChanged(String tabId) {
					    ...
					    Toast.makeText(getApplicationContext(), entity.getName() + " selected", Toast.LENGTH_SHORT).show();
